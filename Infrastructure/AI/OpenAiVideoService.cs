...
public sealed class OpenAiVideoService : IAiVideoService
{
    ...
    public async Task<VideoAiResultDto> GenerateVideoMetaAsync(VideoAiInputDto input, CancellationToken ct)
    {
        ...
        return new VideoAiResultDto(description);
    }
    ...
    private static string BuildPrompt(VideoAiInputDto input)
    {
        ...
        if (input.HighlightType.HasValue)
            sb.AppendLine($"HighlightType: {input.HighlightType.Value}");
    ...
    private static object BuildSchema()
    {
        ...
        // Only description is generated by AI, highlightType is user-selected
        return new
        {
            type = "object",
    ...
    private sealed record StructuredResult(string description);
}
